 ...
 *
 */
public interface DCTermsModule extends Module {

    /**
     * URI of the Dublin Core Module (http://purl.org/dc/terms/).
     *
     */
    String URI = "http://purl.org/dc/terms/";
     ...
     * <p>
     *
     * @param validList the list of String representing the DublinCore module rights to set, an empty
     *            list or <b>null</b> if none.
     *
     */
    void setValidList(final List<String> validList);
     ...
     * <p>
     *
     * @return the first DublinCore module valid, <b>null</b> if none.
     */
    String getValid();
     ...
     * <p>
     *
     * @param valid the DublinCore module rights to set, <b>null</b> if none.
     *
     */
    void setValid(final String valid);

    List<String> getAbstractList();
    void setAbstractList(final List<String> abstractList);
    String getAbstract();
    void setAbstract(String theAbstract);

    List<String> getAccessRightsList();
    void setAccessRightsList(final List<String> accessRightsList);
    String getAccessRights();
    void setAccessRights(String accessRights);

    List<String> getAccrualMethods();
    void setAccrualMethods(final List<String> accrualMethods);
    String getAccrualMethod();
    void setAccrualMethod(String accrualMethod);

    List<String> getAccrualPeriodicityList();
    void setAccrualPeriodicityList(final List<String> accrualPeriodicityList);
    String getAccrualPeriodicity();
    void setAccrualPeriodicity(String accrualPeriodicity);

    List<String> getAccrualPolicyList();
    void setAccrualPolicyList(final List<String> accrualPolicyList);
    String getAccrualPolicy();
    void setAccrualPolicy(String accrualPolicy);

    List<String> getAlternatives();
    void setAlternatives(final List<String> alternatives);
    ...
    void setAvailableList(final List<String> availableList);
    String getAvailable();
    void setAvailable(String available);

    List<String> getBibliographicCitations();
    void setBibliographicCitations(final List<String> bibliographicCitations);
    String getBibliographicCitation();
    void setBibliographicCitation(String bibliographicCitation);

    List<String> getConformsToList();
    void setConformsToList(final List<String> conformsToList);
    String getConformsTo();
    void setConformsTo(String conformsTo);

    List<Date> getCreatedList();
    void setCreatedList(final List<Date> createdList);
    Date getCreated();
    void setCreated(Date created);

    List<Date> getDateAcceptedList();
    void setDateAcceptedList(final List<Date> dateAcceptedList);
    Date getDateAccepted();
    void setDateAccepted(Date dateAccepted);

    List<Date> getDateCopyrightedList();
    void setDateCopyrightedList(final List<Date> dateCopyrightedList);
    Date getDateCopyrighted();
    void setDateCopyrighted(Date dateCopyrighted);

    List<Date> getDateSubmittedList();
    void setDateSubmittedList(final List<Date> dateSubmittedList);
    Date getDateSubmitted();
    void setDateSubmitted(Date dateSubmitted);

    List<String> getEducationLevels();
    void setEducationLevels(final List<String> educationLevels);
    String getEducationLevel();
    void setEducationLevel(String educationLevel);

    List<String> getExtents();
    void setExtents(final List<String> extents);
    String getExtent();
    void setExtent(String extent);

    List<String> getHasFormats();
    void setHasFormats(final List<String> hasFormats);
    String getHasFormat();
    void setHasFormat(String hasFormat);

    List<String> getHasParts();
    void setHasParts(final List<String> hasParts);
    String getHasPart();
    void setHasPart(String hasPart);

    List<String> getHasVersions();
    void setHasVersions(final List<String> hasVersions);
    String getHasVersion();
    void setHasVersion(String hasVersion);

    List<String> getInstructionalMethods();
    void setInstructionalMethods(final List<String> instructionalMethods);
    String getInstructionalMethod();
    void setInstructionalMethod(String instructionalMethod);

    List<String> getIsFormatOfList();
    void setIsFormatOfList(final List<String> isFormatOfList);
    String getIsFormatOf();
    void setIsFormatOf(String isFormatOf);

    List<String> getIsPartOfList();
    void setIsPartOfList(final List<String> isPartOfList);
    String getIsPartOf();
    void setIsPartOf(String isPartOf);

    List<String> getIsReferencedByList();
    void setIsReferencedByList(final List<String> isReferencedByList);
    String getIsReferencedBy();
    void setIsReferencedBy(String isReferencedBy);

    List<String> getIsReplacedByList();
    void setIsReplacedByList(final List<String> isReplacedByList);
    String getIsReplacedBy();
    void setIsReplacedBy(String isReplacedBy);

    List<String> getIsRequiredByList();
    void setIsRequiredByList(final List<String> isRequiredByList);
    String getIsRequiredBy();
    void setIsRequiredBy(String isRequiredBy);

    List<Date> getIssuedList();
    void setIssuedList(final List<Date> issuedList);
    Date getIssued();
    void setIssued(Date issued);

    List<String> getIsVersionOfList();
    void setIsVersionOfList(final List<String> isVersionOfList);
    String getIsVersionOf();
    void setIsVersionOf(String isVersionOf);

    List<String> getLicenses();
    void setLicenses(final List<String> licenses);
    String getLicense();
    void setLicense(String license);

    List<String> getMediators();
    void setMediators(final List<String> mediators);
    String getMediator();
    void setMediator(String mediator);

    List<String> getMediums();
    void setMediums(final List<String> mediums);
    String getMedium();
    void setMedium(String medium);

    List<String> getModifiedList();
    void setModifiedList(final List<String> modifiedList);
    String getModified();
    void setModified(String modified);

    List<String> getProvenances();
    void setProvenances(final List<String> provenances);
    String getProvenance();
    void setProvenance(String provenance);

    List<String> getReferencesList();
    void setReferencesList(final List<String> referencesList);
    String getReferences();
    void setReferences(String references);

    List<String> getReplacesList();
    void setReplacesList(final List<String> replacesList);
    String getReplaces();
    void setReplaces(String replaces);

    List<String> getRequiresList();
    void setRequiresList(final List<String> requiresList);
    String getRequires();
    void setRequires(String requires);

    List<String> getRightsHolderList();
    void setRightsHolderList(final List<String> rightsHolderList);
    String getRightsHolder();
    void setRightsHolder(String rightsHolder);

    List<String> getSpatialList();
    void setSpatialList(final List<String> spatialList);
    String getSpatial();
    void setSpatial(String spatial);

    List<String> getTableOfContentsList();
    void setTableOfContentsList(final List<String> tableOfContentsList);
    String getTableOfContents();
    void setTableOfContents(String tableOfContents);

    List<String> getTemporalList();
    void setTemporalList(final List<String> temporalList);
    String getTemporal();
